...
import serviceSetupsRouter from "./routes/service-setups.ts";
...
import ministriesRouter from "./routes/ministries.ts";
import zonesRouter from "./routes/zones.ts";
...
app.route('/', serviceSetupsRouter);
app.route('/', servicesRouter);
app.route('/', tabAccessRouter);
app.route('/', themeRouter);
app.route('/', usersRouter);
app.route('/', ministriesRouter);
app.route('/', zonesRouter);
