...
app.get('/expenses', async (c) => {
  try {
    ...
    let query = supabase
      ...
      .select(`
        *,
        requested_by_member:members!expense_requisitions_requested_by_fkey(id, first_name, last_name),
        recommended_by_member:members!expense_requisitions_recommended_by_fkey(id, first_name, last_name),
        approved_by_member:members!expense_requisitions_approved_by_fkey(id, first_name, last_name),
