                ...
                <div className="px-4 pt-4 mt-auto">
                    <div className="p-4 rounded-xl bg-sidebar-accent/30 border border-sidebar-border/50">
                        <div className="flex items-center gap-3 mb-3">
                            <div className="w-8 h-8 rounded-full flex items-center justify-center text-white font-bold text-xs ring-2 ring-background" style={{ backgroundColor: 'var(--primary)' }}>
            ...
            >
              ...
              >
                  <div className="flex items-center justify-between px-6 py-5 border-b border-border/50 bg-sidebar/50">
                    <h1 className="text-lg font-bold" style={{ color: 'var(--primary)' }}>CoC.M</h1>
                    <Button
                      variant="ghost"
                      size="icon"
                      onClick={() => setMobileMenuOpen(false)}
