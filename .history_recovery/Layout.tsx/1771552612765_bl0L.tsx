        ...
        <div className="flex">
          ...
          <aside className="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0 z-30" id="sidebar-nav">
            <div className="flex flex-col flex-grow bg-sidebar/95 backdrop-blur-xl border-r border-sidebar-border shadow-sm overflow-y-auto">
              <div className="flex items-center justify-between flex-shrink-0 px-6 py-5 border-b border-sidebar-border/50">
                <h1 className="text-xl font-bold tracking-tight text-sidebar-foreground bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-transparent">
                  CoC.M
                </h1>
                {/* Theme Toggle for Desktop */}
                <div className="flex gap-1 p-1 bg-sidebar-accent/50 rounded-lg border border-sidebar-border/50">
                  {[
                ...
                <div className="px-4 pt-4 mt-auto">
                    <div className="p-4 rounded-xl bg-sidebar-accent/30 border border-sidebar-border/50">
                        <div className="flex items-center gap-3 mb-3">
                            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-primary to-purple-500 flex items-center justify-center text-white font-bold text-xs ring-2 ring-background">
            ...
            >
              ...
              >
                  <div className="flex items-center justify-between px-6 py-5 border-b border-border/50 bg-sidebar/50">
                    <h1 className="text-lg font-bold bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-transparent">CoC.M</h1>
                    <Button
                      variant="ghost"
                      size="icon"
                      onClick={() => setMobileMenuOpen(false)}
