...
app.get('/expenses', async (c) => {
  try {
    ...
    const mapped = (data || []).map((r: any) => ({
      ...toCamelCase(r),
      requestedByName: r.requested_by_profile?.name || null,
      recommendedByName: r.recommended_by_profile?.name || null,
      approvedByName: r.approved_by_profile?.name || null,
