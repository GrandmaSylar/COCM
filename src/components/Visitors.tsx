...
const mockVisitors: Visitor[] = [
  {
    ...
    residenceLocation: 'Tema',
    visitDate: '2024-01-07',
    serviceType: 'Sunday Main Service',
    referredBy: 'Emmanuel Asante',
    interestedInMembership: true,
    notes: 'New to the area, very interested in joining the church',
  ...
  },
  {
    ...
    gender: 'male',
    residenceLocation: 'Spintex',
    visitDate: '2024-01-14',
    serviceType: 'Sunday Main Service',
    interestedInMembership: false,
    notes: 'Visiting from Kumasi, just wanted to attend service',
  ...
  },
  {
    ...
    lastName: 'Mensah',
    otherNames: 'Akosua',
    phone: '+233 54 333 7890',
    gender: 'female',
    residenceLocation: 'Weija',
    visitDate: '2024-01-21',
    serviceType: 'Sunday Main Service',
    interestedInMembership: true,
    notes: 'Friend brought her to church, very engaged during service',
